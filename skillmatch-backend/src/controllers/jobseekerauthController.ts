...
export const signup = async (req: Request, res: Response): Promise<void> => {
  try {
    const { email, password, first_name, last_name, county, city}: JobSeekerSignupData = req.body;
    const requiredFields = ['email', 'password', 'first_name', 'last_name', 'county', 'city'];
    ...
    const result = await query(
      ...
      [email, hashedPassword, first_name, last_name, county, city]
    );
